...
while(a){
    ...
    var giocatore1 = prompt("Giocatore1, inserisci un numero:");
    var giocatore2 = prompt("Giocatore2, inserisci un numero:");
    if(giocatore1 == numeroCasuale){
        alert("Giocatore1 ci hai indovinato!");
    }
    else{
        scarto1 = Math.abs(numeroCasuale - giocatore1);
    }
    if(giocatore2 == numeroCasuale){
        alert("Giocatore2 ci hai indovinato!");
    }
    else{
        scarto2 = Math.abs(numeroCasuale - giocatore2);
    }
    if(scarto1 < scarto2){
        alert("Nessuno dei due ha indovinato il numero casuale, ma il giocatore 1 si è avvicinato di più il numero era " + numeroCasuale);
    }
    else{
        alert("Nessuno dei due ha indovinato il numero casuale, ma il giocatore 2 si è avvicinato di più! il numero era " + numeroCasuale);
    }
