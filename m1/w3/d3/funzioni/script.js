/* funzione anonima (da sola cosi è inutile) e da anche errore perchè non ha nome
function(){
...
//bottone.onclick = miaFunzione; // altrà possibilità per usare onclick
...
moltiplica2(2,3,8) // mi farà 2 * 3 * 8


function mnoltiplica3(a,b,c = 5){ 
    let terzoValore = c || 1
...
function moltiplica3(a,b,c = 5){
    if(c != undefined){
         var res= a * b * terzoValore;
    }else{
         var res= a * b;
    }
...
let incrementa = a => a + 1; // con un solo paramentro le parentesi tonde sono facoltative
...
let divisioneProEvolutionn = (a,b) => { //con la presenza delle graffe il return non è implicito
